...
namespace Error.Handler.Sample.Api.Repository.Interface
{
    ...
    public interface IExerciseActivityRepo
    {
        ...
        ExerciseActivityEntity AddExerciseActivity(ExerciseActivityEntity exerciseActivityToAdd);
        ...
        bool DeleteExerciseActivity(Guid id);
        ...
        List<ExerciseActivityEntity> GetExerciseActivities();
        ...
        ExerciseActivityEntity GetExerciseActivityById(Guid id);
        ...
        /// </returns>
        (ExerciseActivityEntity exerciseActivity, bool successfullyUpdated) UpdateExerciseActivity(
